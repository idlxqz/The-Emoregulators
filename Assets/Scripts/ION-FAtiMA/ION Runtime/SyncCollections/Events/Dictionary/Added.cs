...
{
    internal sealed class Added<TKey, TValue, TDictionary>
        : DictionaryChanged<TKey, TValue, TDictionary>, IAdded<TKey, TValue, TDictionary>
    {
        public Added(TKey key, TValue value, TDictionary dictionary)
            : base(key, value, dictionary) {}

        public Added(Event evt) : base(evt) {}
