...
{
    public interface IRemoved : IDictionaryChanged
    {
        object Key { get; }
        object Value { get; }
    }

    public interface IRemoved<TKey, TValue> : IRemoved
    {
        new TKey Key { get; }
        new TValue Value { get; }
    }

    public interface IRemoved<TKey, TValue, TDictionary> : IRemoved<TKey, TValue>, IDictionaryChanged<TDictionary> {}
}
