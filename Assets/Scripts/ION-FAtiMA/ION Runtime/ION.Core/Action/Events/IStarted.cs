...
{
	 /// <remarks>
    /// Indicates that an Action has changed its state to Running.
    /// </remarks>
    public interface IStarted : IStateChanged { }
	
    /// <remarks>
    /// Indicates that an Action has changed its state to Running.
    /// </remarks>
    public interface IStarted<TAction> : IStateChanged<TAction>, IStarted
