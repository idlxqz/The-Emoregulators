...
{
	 /// <remarks>
    /// Indicates that an Action has changed its state to Paused.
    /// </remarks>
    public interface IPaused : IStateChanged { }
	
    /// <remarks>
    /// Indicates that an Action has changed its state to Paused.
    /// </remarks>
    public interface IPaused<TAction> : IStateChanged<TAction>, IPaused
