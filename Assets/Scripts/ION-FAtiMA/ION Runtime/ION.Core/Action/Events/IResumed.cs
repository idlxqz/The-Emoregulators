...
{
	/// <remarks>
    /// Indicates that an Action has changed its state from Paused to Running.
    /// </remarks>
    public interface IResumed : IStateChanged { }
	
    /// <remarks>
    /// Indicates that an Action has changed its state from Paused to Running.
    /// </remarks>
    public interface IResumed<TAction> : IStateChanged<TAction>, IResumed
